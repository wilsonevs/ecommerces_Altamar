...
(function(window, document, angular, undefined) {
	angular.module('ng-nestable', [])
		...
		.directive('ngNestable', ['$compile', '$nestable', '$parse', function($compile, $nestable, $parse) {
			return {
				restrict: 'A',
				require: 'ngModel',
						...
						$scope.$watchCollection(function() {
							...
							if (model && element.is(':empty')) {
								...
								root.on('change', function() {
									...
									//var modelValue = JSON.parse( root.nestable('serialize') );
									//$ngModel.$modelValue = JSON.parse( root.nestable('serialize') );
									//console.log(JSON.stringify(root.nestable('serialize')));
									//$parse($attrs.ngModel).assign($scope, root.nestable('serialize') );
									//$scope.ngModel= 'adasd';
