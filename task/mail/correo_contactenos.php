...
$mail=new NotificacionContactenos();
$mail->exec();

class NotificacionContactenos
{
    public function exec()
    {
        ...
        $d = Models\Runtime\EavModel::item( (object)[
        	"filter"=>"items.category_id = 8 and items.item_id=:item_id",
        	"params"=>[
        		":item_id"=>$item_id
        	]
        ]);
        ...
        Cm\Mail::send((object)[
            ...
            // "bcc"=>$destinos_correo,
            "to"=>$destinos_correo,
            "subject"=>"Nueva notificación de contacto en {$cfg["appHost"]}",
            "html"=>$html
        ]);
